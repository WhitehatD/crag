...
The README keeps the pitch and the 5-minute quick start. Everything below
is reference material for users who are already convinced and want to go
deeper.
...
| File | Contents |
|---|---|
| [../benchmarks/phase1-benchmark.md](../benchmarks/phase1-benchmark.md) | 50-repo phase 1 benchmark, 1,809 gates |
