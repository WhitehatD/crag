...
function generateGeminiMd(cwd, parsed) {
  ...
  const content = [
    ...
    securityBlock,
    '',
    parsed.antiPatterns && parsed.antiPatterns.trim() ? '### Anti-Patterns' : null,
    parsed.antiPatterns && parsed.antiPatterns.trim() ? '' : null,
    parsed.antiPatterns && parsed.antiPatterns.trim() ? parsed.antiPatterns.trim() : null,
    parsed.antiPatterns && parsed.antiPatterns.trim() ? '' : null,
    '### Workflow',
    '',
    commitLine,
